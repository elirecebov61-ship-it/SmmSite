...
.sb-nav a[href="/balance"]::after{content:'';position:absolute;top:0;left:-150%;width:35%;height:100%;background:linear-gradient(115deg,transparent,rgba(59,130,246,.35),transparent);transform:skewX(-20deg);animation:btnSheen 2.6s ease-in-out infinite;pointer-events:none;}
...
.plat-tab.active::after{content:'';position:absolute;top:0;left:-150%;width:55%;height:100%;background:linear-gradient(115deg,transparent,rgba(255,255,255,.65),transparent);transform:skewX(-20deg);animation:btnSheen 2.6s ease-in-out infinite;pointer-events:none;}
