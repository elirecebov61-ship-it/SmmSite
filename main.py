...
def wico(size=16, color="#3B82F6", mr=0):
    ...
    return (f'<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" '
            ...
            f'vertical-align:-3px;{mrg}"><rect x="3" y="3" width="18" height="18" rx="2.5" '
            f'stroke="{color}" stroke-width="2"/><line x1="12" y1="3" x2="12" y2="21" '
            f'stroke="{color}" stroke-width="2"/><line x1="3" y1="12" x2="21" y2="12" '
