...
function pjaxGo(url, push){
  pjaxFetch(url, {method:'GET'}, push!==false, false);
}
...
def render_orders(user, bal_info, orders, new=False):
    ...
    if not orders:
        ...
        for o in orders:
            ...
            pdesc = (o.get("product_desc") or "").lower()
            prod_supports_cancel = "ləğv" in pdesc or "legv" in pdesc
            prod_supports_restore = "bərpa" in pdesc or "berpa" in pdesc
