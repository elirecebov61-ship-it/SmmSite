...
LOGO_SVG = '<img src="/logo.png" alt="PanelimAz" style="height:38px;width:auto;">'
...
<div class="order-panel">
  ...
  <div class="plat-tabs" id="plat-tabs">
    <button type="button" class="plat-tab active" data-plat="all" onclick="selectPlatform('all',this)"><span class="plat-ic">🔥</span>Hamısı</button>
    ...
    <button type="button" class="plat-tab" data-plat="youtube" onclick="selectPlatform('youtube',this)"><span class="plat-ic">▶️</span>YouTube</button>
    <button type="button" class="plat-tab" data-plat="twitter" onclick="selectPlatform('twitter',this)"><span class="plat-ic">🐦</span>Twitter</button>
    <button type="button" class="plat-tab" data-plat="whatsapp" onclick="selectPlatform('whatsapp',this)"><span class="plat-ic">💬</span>WhatsApp</button>
    <button type="button" class="plat-tab" data-plat="discord" onclick="selectPlatform('discord',this)"><span class="plat-ic">🎮</span>Discord</button>
...
function changeCat(cat){{
  ...
  prods.forEach(function(p){{
    ...
    o.innerText=p.name+' — '+p.price+' ₼/1000';
    sel.appendChild(o);
  }});
...
function selectPlatform(plat,btn){{
  ...
  catSel.innerHTML = plat==='all' ? '<option value="all">🔥 Bütün Xidmətlər</option>' : '';
  ...
  if(plat==='all'){{
    ...
    catSel.value=matchedCats[0];
    changeCat(matchedCats[0]);
  }}else{{
    var sel=document.getElementById('svc-select');
