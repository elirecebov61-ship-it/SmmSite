...
def wico(size=16, color="#3B82F6", mr=0):
    """Bütün saytda tutarlı istifadə olunan 'pəncərə' ikonu — kvadrat çərçivə
    içində üfüqi/şaquli bölücü xətlərlə (real pəncərə şüşəsi kimi). Real şəkil
    (SVG) olduğu üçün heç bir cihazda/brauzerdə (emoji şrifti olsun-olmasın)
    boş kvadrat kimi sınmır — həmişə eyni cür, mavi rəngdə görünür."""
    mrg = f"margin-right:{mr}px;" if mr else ""
    return (f'<svg width="{size}" height="{size}" viewBox="0 0 24 24" fill="none" '
            f'xmlns="http://www.w3.org/2000/svg" style="flex-shrink:0;display:inline-block;'
            f'vertical-align:-3px;{mrg}"><rect x="3" y="3" width="18" height="18" rx="3" '
            f'stroke="{color}" stroke-width="2"/><path d="M3 12H21M12 3V21" '
