...
def wico(size=16, color="#3B82F6", mr=0):
    """Bütün saytda tutarlı istifadə olunan 🪟 pəncərə emojisi.
    (Qeyd: rəngli emoji olduğu üçün CSS ilə mavi rəngə boyanmır, amma
    özü artıq mavi-boz şüşə tonunda olduğundan uyğun görünür.)"""
    mrg = f"margin-right:{mr}px;" if mr else ""
    return f'<span style="font-size:{size}px;{mrg}line-height:1;display:inline-block;vertical-align:-3px;">🪟</span>'
